...
# Truncation at LoD
stanmodel_trunc_A <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-trunc.stan", model_name = "stanmodel_trunc_A")
samples_trunc_A <- sampling(stanmodel_trunc_A, data = standata_A, iter = 10000, warmup = 5000, 
...
# Censoring Above LoD
stanmodel_cens_A <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-cens.stan", model_name = "stanmodel_cens_A")
samples_cens_A <- sampling(stanmodel_cens_A, data = standata_A, iter = 10000, warmup = 5000, 
                         chains = 4, thin = 10, check_data = FALSE, cores = 4, 
                         control = list(max_treedepth = 15))
...
stanmodel_bin_A <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-bin.stan", model_name = "stanmodel_bin_A")
samples_bin_A <- sampling(stanmodel_bin_A, data = standata_bin_A, iter = 10000, warmup = 5000, 
                          chains = 4, thin = 10, check_data = FALSE, cores = 4,
                          control = list(max_treedepth = 15))
...
# Truncation at LoD
stanmodel_trunc_B <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-trunc.stan", model_name = "stanmodel_trunc_B")
samples_trunc_B <- sampling(stanmodel_trunc_B, data = standata_B, iter = 10000, warmup = 5000,
                            chains = 4, thin = 10, check_data = FALSE, cores = 4,
                            control = list(max_treedepth = 15))
...
# Censoring above LoD
stanmodel_cens_B <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-cens.stan", model_name = "stanmodel_cens_B")
samples_cens_B <- sampling(stanmodel_cens_B, data = standata_B, iter = 10000, warmup = 5000, 
...
stanmodel_bin_B <- stan_model(file = "~/Github/ra-biomarker/stan/mixture-bin.stan", model_name = "stanmodel_bin_B")
samples_bin_B <- sampling(stanmodel_bin_B, data = standata_bin_B, iter = 10000, warmup = 5000, 
                        chains = 4, thin = 10, check_data = TRUE, cores = 4,
                        control = list(max_treedepth = 15))
